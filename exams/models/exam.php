...
class Exam extends MY_Model {
	...
	{
		$this->db->insert($this->db->dbprefix('dti_exams'), $data);
	...
	public function get_all_exams_records()
	{
	...
	public function get_specific_exams_records($params)
	{

		$this->db->order_by("name", "desc");
		$exams = $this->db->get_where($this->db->dbprefix('dti_exams'), $params)->result_array();
